...
public class Test_3 {
	...
	@Test
	void testTotalTemporalNodesCount() {
	...
	@Test
	void testAddNewTemporalNodeAtBeginning()
	...
	@Test
	void testListSizeIncreasesAfterAddingNodeAtBeginning()
			throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
	...
	@Test
	void testAddNewTemporalNodeAtEnd()
			throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
	...
	@Test
	void testAddNewTemporalNodeInMiddle()
			throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
	...
	@Test
	void testNumPersonsBetweenTwoInstants()
			throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
	...
	@DisplayName("Comprobamos el numero de personas entre dos instantes temporales")
	@Test
	void testNumPersonsBetweenSameInstant()
			throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
	...
	@Test
	void testNumCoordinateNodesBetweenTwoInstants()
			throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
		FechaHora ini = new FechaHora(25, 5, 2021, 16, 36);
		FechaHora fin = new FechaHora(25, 5, 2021, 16, 36);
	...
	@Test
	void testNumNodesAndPersonsInTimeRange()
			throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
		FechaHora ini = new FechaHora(25, 5, 2021, 16, 30);
	...
	@Test
	void testAddNewCoordinateNodeToExistingTemporalNode()
			throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException,
			EmsDuplicateLocationException {
		FechaHora ini = new FechaHora(25, 5, 2021, 16, 36);
		FechaHora fin = new FechaHora(25, 5, 2021, 16, 36);
